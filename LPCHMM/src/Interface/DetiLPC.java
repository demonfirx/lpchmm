...
import LPCFeatureExtraction.FeatureExtraction;
import LPCFeatureExtraction.SpeechProcessing;
 ...
 * @author DAN
 */
public class DetiLPC extends javax.swing.JFrame {
    private int CF, LPC_COEFF_NUMBER;
    ...
    public static void setNormal(double[][] normal) {
        DetiLPC.normal = normal;
    }

    public static void setThreshold(double[][] threshold) {
        DetiLPC.threshold = threshold;
    }
    
    
    /**
     *
     * @param LPC_COEFF_NUMBER Jumlah Koefisien LPC yang diinginkan 
     * @param CF Considered Frame
     * @param SF Start Point Frame
     * @param EF End Point Frame
     */
    public DetiLPC(int LPC_COEFF_NUMBER, int CF, double SF, double EF){
        initComponents();
        this.LPC_COEFF_NUMBER = LPC_COEFF_NUMBER;
        this.CF = CF;
        this.SF = SF;
        this.EF = EF;
        
        txtLokasiFileAudio.setText("Koefisien : "+String.valueOf(LPC_COEFF_NUMBER)+
                "CF : "+CF+
                "SF : "+SF+
                "EF : "+EF);
    ...
    private double[][] hitungLPC(String lokasi, int CF, double SP, double EP, int koefisienLPC){       
        ...
        //just for displaying removal Result Signal sake!!!!
        ArrayList<Double> removalsignal = sp.removal(nonSilence);
        
        for (int i = 0; i < removalsignal.size(); i++) {
            txtAreaRemoval.append("("+i+") \t"+String.valueOf(formatSembilan.format(removalsignal.get(i)))+"\t HASIL SILENCE REMOVAL -> REMOVAL\n");
        }
        
        // REMOVAL - PRE EMPHASIS 
        ArrayList<Double> preEmphasisSignal = sp.preEmphasis(removalsignal);
         
        for (int i = 0; i < preEmphasisSignal.size(); i++) {
            txtAreaPreEmp.append("("+i+") \t"+String.valueOf(formatSembilan.format(preEmphasisSignal.get(i)))+"\t HASIL REMOVAL -> PRE EMPHASIS \n");
        }
        ...
        FeatureExtraction lpc = new FeatureExtraction(nonSilence.size(),samplePoint,frameRate);        
        lpc.frameBlocking(preEmphasisSignal);   
        ...
        for (int i = 0; i < frameRate; i++) {
            ...
            for (int j = start; j < start+samplePoint; j++) {
                if (preEmphasisSignal!=null) {
                    lpc.frame[i][j-start] = preEmphasisSignal.get(j);
                } else {
                    lpc.frame[i][j-start] = 0.0;
                }
                txtAreaFrameBlocking.append(String.valueOf(formatSembilan.format(lpc.frame[i][j-start]))+"\t");
            }
...
//        double EP = 0.94;
        ...
        for (int i = 0; i < consideredFrame.length; i++) {
            ...
            for (int j = 0; j < lpc.frame[0].length; j++) {
                txtAreaTimeAlignment.append(String.valueOf(lpc.frame[indexCF][j])+"\t");
                choosenFrame[i][j] = lpc.frame[indexCF][j];
            }
            txtAreaTimeAlignment.append("\n");
        }
   
        // WINDOWING
        double[][] windowingResult = lpc.windowing(choosenFrame);
    ...
    private void initComponents() {
        ...
        panelRemoval = new javax.swing.JPanel();
        ...
        tabPaneLPC = new javax.swing.JTabbedPane();
        ...
        btnAnalisis.setBackground(new java.awt.Color(51, 204, 255));
        btnAnalisis.setText("Analyze LPC");
        ...
        btnBrowseFile.setBackground(new java.awt.Color(51, 204, 255));
        ...
        grupPreProcessing.setBackground(new java.awt.Color(51, 204, 255));
        ...
        tabPanePreProcessing.setBackground(new java.awt.Color(51, 204, 255));
        ...
        tabPanePreProcessing.addTab("Silence Removal", panelSilenceRemoval);

        txtAreaRemoval.setColumns(20);
        txtAreaRemoval.setRows(5);
        jScrollPane3.setViewportView(txtAreaRemoval);

        javax.swing.GroupLayout panelRemovalLayout = new javax.swing.GroupLayout(panelRemoval);
        panelRemoval.setLayout(panelRemovalLayout);
        panelRemovalLayout.setHorizontalGroup(
            panelRemovalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 865, Short.MAX_VALUE)
        );
        panelRemovalLayout.setVerticalGroup(
            panelRemovalLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jScrollPane3, javax.swing.GroupLayout.DEFAULT_SIZE, 280, Short.MAX_VALUE)
        );

        tabPanePreProcessing.addTab("", panelRemoval);
        ...
        grupEkstraksiCiri.setBackground(new java.awt.Color(51, 204, 255));
        ...
        tabPaneLPC.setBackground(new java.awt.Color(51, 204, 255));
        ...
        tabPaneLPC.addTab("", panelMelFreq);
        ...
        tabPaneLPC.addTab("Normalisasi", panelNormalisasi);
        ...
        tabPaneLPC.addTab("Thresholding", panelThresholding);
    ...
    private void btnAnalisisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalisisActionPerformed
        ...
        hitungLPC(lokasiFile, CF, SF, EF, LPC_COEFF_NUMBER+1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetiLPC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JPanel panelRemoval;
    ...
    private javax.swing.JTabbedPane tabPaneLPC;
    ...
    private javax.swing.JTextArea txtAreaRemoval;
