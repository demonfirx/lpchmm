...
public class HalamanEkstraksiCiri extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnDetilLPC = new javax.swing.JButton();
        ...
        textAreaLPCCoefficient = new javax.swing.JTextField();
        ...
        jLabel1.setText("LPC Feature Extraction");
        ...
        btnDetilLPC.setText("LPC Detail");
        btnDetilLPC.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDetilLPCActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(btnDetilLPC, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel1)
                    .addComponent(btnDetilLPC, javax.swing.GroupLayout.PREFERRED_SIZE, 69, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );
        ...
        txtAreaFolderLocation.setText("D:TEST");

        btnExtract.setText("Extract with LPC");
        ...
        jLabel10.setText("No. of LPC Coefficient");

        textAreaLPCCoefficient.setText("12");
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(textAreaLPCCoefficient, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel10)
                    .addComponent(textAreaLPCCoefficient, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(8, 8, 8)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
    ...
    private void btnExtractActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExtractActionPerformed
        ...
        System.out.println(txtAreaCF.getText());
        koefisienLPC = Integer.valueOf(textAreaLPCCoefficient.getText());
        lokasi = txtAreaFolderLocation.getText();
        lokasiCSVTarget = txtAreaCSVTarget.getText();
        @SuppressWarnings("LocalVariableHidesMemberVariable")
        int FREKUENSI_SAMPLING;
        /*
        ...
        */
        ...
        double[][] convertArray = new double[listOfFiles.length][CF * koefisienLPC];
        ...
        for (int i = 0; i < listOfFiles.length; i++) {
            ...
            //simpan hasil perhitungan LPC kedalam file CSV
            // #1 insert the result of LPC with time alignment to 2dimensional array
//            hitungLPC(file[i].getAbsolutePath(), CF, SP, EP, koefisienLPC+1);
            double[] fitur = am.matrixToArray(hitungLPC(file[i].getAbsolutePath(), CF, SP, EP, koefisienLPC+1));
            try {
                ...
                jTextArea1.append("Fitur LPC dari file "+file[i].getName()+" telah didapatkan, termasuk kedalam kategori "+kelasTarget+" ==> "+i+"\n");
            ...
            // #3 Bingo! you got the LPC extraction result in CSVFile
        }
    ...
    private void btnDetilLPCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetilLPCActionPerformed
        //DetilLPC d = new DetiLPC();
        CF = Integer.valueOf(txtAreaCF.getText());
        koefisienLPC = Integer.valueOf(textAreaLPCCoefficient.getText());
        DetiLPC d = new DetiLPC(koefisienLPC,CF,SP,EP);
        d.setVisible(true);
    }//GEN-LAST:event_btnDetilLPCActionPerformed
...
//            txtAreaFrameBlocking.append(String.valueOf(i)+"\t");
            for (int j = start; j < start+samplePoint; j++) {
                if (preEmphasisSignal!=null) {
                    FeatureExtraction.frame[i][j-start] = preEmphasisSignal.get(j);
                } else {
                    FeatureExtraction.frame[i][j-start] = 0.0;
                }
//                txtAreaFrameBlocking.append(String.valueOf(formatEmpat.format(lpc.frame[i][j-start]))+"\t");
            }
...
//            txtAreaTimeAlignment.append(Integer.toString(i)+"\t");
            System.arraycopy(FeatureExtraction.frame[indexCF], 0, choosenFrame[i], 0, FeatureExtraction.frame[0].length);//                txtAreaTimeAlignment.append(String.valueOf(lpc.frame[indexCF][j])+"\t");
//            txtAreaTimeAlignment.append("\n");
        ...
        double[][] fftResult= lpc.transform(windowingResult);
        ...
        double[][] melFreqEnergy = lpc.filter(fftResult,16000,30,130,6800);

//        

     
        lpc.discreteCosineTransform(melFreqEnergy, koefisienLPC);
        System.out.println(lpc.dctCepstrum.length+" "+lpc.dctCepstrum[0].length);
    ...
    private javax.swing.JButton btnDetilLPC;
    ...
    private javax.swing.JTextField textAreaLPCCoefficient;
